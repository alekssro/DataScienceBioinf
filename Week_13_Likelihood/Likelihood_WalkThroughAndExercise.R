...
# Representing the likelihood function (using base fucntion you can also use ggplot)
...
which.max(ys) ##finding the index position of the max in the ys vector
xs[which.max(ys)] ##you get the value at the index position of the max in the ys vector.
